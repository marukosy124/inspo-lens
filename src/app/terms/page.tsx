        ...
        <section className="space-y-5 leading-relaxed text-gray-700">
          ...
          <div className="space-y-3">
            ...
            <ul className="list-inside list-disc space-y-1 text-sm">
              ...
              <li>
                Attempting to overload, scrape, or reverse-engineer the service
              </li>
              <li>Abusing rate limits or disrupting availability for others</li>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm">
              This is a free tool provided as-is. I aim to keep it running, but
              offer no guarantees of uptime or accuracy.
            </p>
          </div>
